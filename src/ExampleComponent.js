...
export default class CanvasDraw extends PureComponent  {
  ...
  static defaultProps = {
    ...
    canvasHeight: 375,
    disabled: false,
    imgSrc: "https://i.ibb.co/WsRTJn0/Screen-Shot-2023-03-08-at-10-26-47-PM.png",
    saveData: "",
  ...
  //     // Update Retool component with updated dataURL value
  //     updateModel("canvasDataURLInput", dataURL);
  //   });
  // }
          ...
          <button
            onClick={() => {
              this.props.updateModel({
                getDataURLInput: this.getDataURL()
              })
